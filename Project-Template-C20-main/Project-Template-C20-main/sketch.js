...
function draw() {
  ...
  if(keyDown("m")){
    ...
    moveNum = Math.round(random(0,8))
    switch (moveNum) {
      case 1: astronaut.velocityX = 0; astronaut.velocityY = 1;
        break;
      case 2: astronaut.velocityX = 1; astronaut.velocityY = 1;
        break;
      case 3: astronaut.velocityX = 1; astronaut.velocityY = 0;
        break;
      case 4: astronaut.velocityX = 1; astronaut.velocityY = -1;
        break;
      case 5: astronaut.velocityX = 0; astronaut.velocityY = -1;
        break;
      case 6: astronaut.velocityX = -1; astronaut.velocityY = 1;
        break;
      case 7: astronaut.velocityX = -1; astronaut.velocityY = 0;
        break;
      case 8: astronaut.velocityX = -1; astronaut.velocityY = 1;
        break;
      default: break;
    }
  }
